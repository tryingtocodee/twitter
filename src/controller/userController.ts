...
import { createUserValidation, loginSchema } from "../validation/userValidation";
import jwt from "jsonwebtoken"
import dotenv from "dotenv"
import { createUserService, loginService } from "../service/userService";
...
export async function loginController(req : Request , res : Response) : Promise<any>{
    try {
       ...
       const user = await loginService(validation.data)
